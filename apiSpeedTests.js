...
const runComparisonSpeedTests = async (qty) => {
  ...
  const nodeCloudFunction = "https://europe-west1-companies-house-data.cloudfunctions.net/getCompanyInfo?company_number=";
  const goCloudFunction = "https://europe-west1-companies-house-data.cloudfunctions.net/getCompanyInfoGo?company_number=";
  const pythonCloudFunction = "https://europe-west1-companies-house-data.cloudfunctions.net/getCompanyInfoPython?company_number=";
